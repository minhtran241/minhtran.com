    ...
    return (
        <>
            <div className="relative flex flex-col">
                <ul className="flex justify-end gap-[3px] overflow-hidden text-xs dark:text-gray-400 md:justify-start">
                    {months.map((month) => (
                        <li
                            key={month.firstDay}
                            className={clsx(
                            ...
                            {week.contributionDays.map((contribution) => {
                                ...
                                return (
                                    <motion.span
                                        ...
                                        className="my-[2px] block h-[12px] w-[12px] rounded-sm bg-gray-300 dark:bg-gray-800"
                                        style={
                                            backgroundColor
                                                ? { backgroundColor }
                                                : undefined
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center gap-2 text-sm">
                    <span className="dark:text-gray-400">Less</span>
                    <ul className="flex gap-1">
                        <motion.li className="h-[10px] w-[10px] rounded-sm bg-gray-300 dark:bg-gray-800" />
                ...
                <div
                    className={clsx(
                        ...
                        'rounded bg-gray-200 px-2 text-sm dark:bg-gray-700'
                    )}
                >
